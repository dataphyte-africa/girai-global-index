...
export interface DimensionHeroProps {
  name: string;
  lead: string;
  heroImage: string;
}
...
/**
 * Wide banner hero for a dimension detail page. Background photography sits
 * on the right; copy overlays the left with a two-tone title.
 */
export function DimensionHero({ name, lead, heroImage }: DimensionHeroProps) {
  return (
        ...
        <div className="relative overflow-hidden rounded-[28px] md:rounded-[32px]">
          ...
          <div className="relative flex min-h-[360px] flex-col justify-center px-8 py-12 md:min-h-[565px] md:max-w-[58%] md:px-14 md:py-16 lg:min-h-[565px]">
            <h1 className="text-[2rem] font-bold leading-[1.12] tracking-tight md:text-5xl lg:text-[3.25rem]">
              <span style={{ color: HERO_TITLE_ACCENT }}>{name}</span>
